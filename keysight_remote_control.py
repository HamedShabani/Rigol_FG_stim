...
class KeysightBurstGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Keysight 33210A Burst Controller")
    ...
    def run_sequence(self):
        ...
        def worker():
            ...
            try:
                ...
                self.ui(self.set_status, f"Configured: {freq} Hz, {dur} s ({cycles} cycles), {amp} Vpp")
                self.show_last_error()
                ...
                for i in range(1, reps + 1):
                    ...
                    self.ui(self.set_status, f"Burst {i}/{reps}")
                    self.write("*TRG")
